...
const compareNums = (num1, num2) => {
  return (num1 > num2 ? num1 : num2 > num1 ? num2 : num1 === num2 ? num1 : "function error")
}
...
let number1 = Number(param1);
//console.log(number1)
let number2 = Number(param2);
...
let nameGreeting = nameCheck("Jaclyn");
...
console.log(bigOrSmall([5,4,2,3,1]))
...
function chocolateFrogs2(gold) {
  myFrogs = Math.floor(gold /= 3);
  return myFrogs;
}
let totalFrogs2 = chocolateFrogs2(128);
